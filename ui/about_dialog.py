...
DEPENDENCIES = [
    ...
    ("Qt / PyQt6",      "6.6+",       "GPL-3.0 / Commercial (Riverbank)",
                                                    "https://www.riverbankcomputing.com/software/pyqt/"),
    ("whisper.cpp",     "HEAD",       "MIT",        "https://github.com/ggerganov/whisper.cpp"),
    ("OpenAI Whisper model (large-v3-turbo)",
                        "2024",       "MIT",        "https://github.com/openai/whisper"),
...
class AboutDialog(QDialog):
    ...
    def _licenses_tab(self) -> QWidget:
        ...
        html += ("<tr style='background:palette(alternate-base);'>"
...
class ChangelogDialog(QDialog):
    def __init__(self, parent=None):
        ...
        browser = QTextBrowser()
        browser.setOpenExternalLinks(True)
        text = CHANGELOG_PATH.read_text(encoding="utf-8") if CHANGELOG_PATH.exists() \
