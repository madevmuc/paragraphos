...
class SettingsPane(QWidget):
    ...
    def _terminal_help_html(self) -> str:
        return (
            ...
            "(podcast by iTunes name / RSS URL, or YouTube channel by URL); "
            "seeds episodes as pending<br>"
            "&nbsp;• <b>list</b> — prints the watchlist (podcasts + YouTube)<br>"
            "&nbsp;• <b>check [--show &lt;slug&gt;] [--limit N]</b> — full pipeline "
            "(captions-first for YouTube, whisper fallback)<br>"
    ...
    def _agent_prompt_plain(self) -> str:
        return (
            ...
            "for podcasts (RSS) AND YouTube channels. v1.2.0+ supports both\n"
            "sources side-by-side; YouTube uses uploader-provided captions when\n"
            "available and falls back to whisper-cli when not. yt-dlp is lazy-\n"
            "installed to ~/Library/Application Support/Paragraphos/bin/yt-dlp\n"
            "on first YouTube use.\n"
            "\n"
            ...
            "\n"
            "Settings of interest (in settings.yaml):\n"
            ...
            "  ytdlp_last_self_update_at: ''     # ISO timestamp; auto-updates weekly\n"
            "\n"
            ...
            "  list                      — print the current watchlist (source column shows\n"
            "                              'podcast' or 'youtube')\n"
            ...
            "  · 'Disable the YouTube source temporarily, run a check pass, then\n"
            "     re-enable it.'\n"
