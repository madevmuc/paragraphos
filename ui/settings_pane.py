...
class SettingsPane(QWidget):
    def __init__(self, ctx):
        ...
        self._add_field(f1, "Output root", self._row_widget(pick_row),
        ...
        self._add_field(f1, "Obsidian vault path", self._row_widget(obs_row),
        ...
        self._add_field(f1, "Knowledge-hub root (optional)",
                        self._row_widget(kb_row),
                        hint=kb_hint, hint_kind=kb_kind)
        root.addLayout(f1)
        ...
        self._add_field(f2, "Daily check time", self.time,
        ...
        self._add_field(f2, "Catch-up missed runs", self.catchup,
        ...
        self._add_field(f3, "Notify on successful transcription",
        ...
        self._add_field(f4, "Whisper model", self._row_widget(model_row),
        ...
        self._add_field(f4, "Parallel workers", self.parallel,
        ...
        self._add_field(f4, "Bandwidth limit (Mbps, 0=∞)", self.bw,
        ...
        self._add_field(
            f4, "Multi-processor split", self.multiproc,
        ...
        self._add_field(f5, "MP3 retention (days)", self.retention,
        ...
        self._add_field(f5, "Delete MP3 after transcribe", self.del_mp3,
        ...
        self._add_field(f5, "Log retention (days)", self.log_retention,
    ...
    def _kb_root_hint(self, path: str):
        ...
        return (f"path does not exist — transcripts will not be mirrored there", "info")
    ...
    def _hw_recommendation_value(self) -> int:
        ...
        if mem_gb is None or ncpu is None:
            return 1
        if mem_gb < 16: return 1
        if mem_gb <= 32 and ncpu >= 8: return 2
        return 3
