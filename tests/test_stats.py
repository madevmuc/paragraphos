...
def test_global_stats(tmp_path: Path):
    db = _seed(tmp_path)
    db.upsert_episode(
        show_slug="s", guid="a", title="A", pub_date="2026-04-01", mp3_url="u", duration_sec=600
    )
    db.upsert_episode(
        show_slug="s", guid="b", title="B", pub_date="2026-04-02", mp3_url="u", duration_sec=1200
    )
...
def test_rescan_library_counts(tmp_path: Path):
    db = _seed(tmp_path)
    db.upsert_episode(show_slug="demo", guid="gg", title="t", pub_date="2026-04-01", mp3_url="u")
